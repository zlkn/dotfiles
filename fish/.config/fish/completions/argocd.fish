...
function __argocd_prepare_completions
    ...
    set -l results (__argocd_perform_completion)
    __argocd_debug "Completion results: $results"
    ...
    set --global __argocd_comp_results $results[1..-2]
...
complete -c argocd -n __argocd_prepare_completions -f -a '$__argocd_comp_results'
