...
local function get_icon(tab)
    local icons = {
        ...
        ["ssh"] = { symbol = wezterm.nerdfonts.md_cloud, color = colorscheme.palette.brights.cyan },
        ["sftp"] = { symbol = wezterm.nerdfonts.md_cloud, color = colorscheme.palette.brights.cyan },
