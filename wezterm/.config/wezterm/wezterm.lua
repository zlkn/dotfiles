...
-- colors/aqua_day.toml and colors/aqua_night.toml are generated by scripts/gen-palette.py
-- config.color_scheme = "zenbones"
config.color_scheme = "zenwritten_light"
-- config.color_scheme = require("palette").variant
